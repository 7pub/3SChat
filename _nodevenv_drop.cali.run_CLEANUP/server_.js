var http = require('http'),
    ...
    Router = require('/home/theoreme/nodevenv/drop.cali.run');

var fileServer = ecstatic({ root: '/home/theoreme/nodevenv/drop.cali.run' });
...
function respondJSON(response, status, data) {
    respond(response, status, JSON.stringify(data), { 'Content-Type': 'application/json' })
}
